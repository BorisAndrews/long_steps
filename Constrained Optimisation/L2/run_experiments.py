...
def run_experiment(solver_type, cycle, extra_args=None):
    ...
    -----------
    solver_type : str
        Type of solver ("gradient_periodic", "gradient_linesearch", or "gradient_chebyshev")
    cycle : str
        Cycle name (e.g., "3", "7", "linesearch", "0.2", "0.4")
    extra_args : list
    ...
    elif solver_type == "gradient_chebyshev":
        cmd.extend(["--chebyshev-tau-rate", cycle])
